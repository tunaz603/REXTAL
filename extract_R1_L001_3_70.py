...
fp = open('/scratch-lustre/tisla003/Original_Data/longranger/longranger_input/HG00353/HG00353_S1_L001_R1_001.fastq', 'r')
...
fo = open('print_L001_R1_3_70.fastq', 'w')
line_count = 1501299476  # line count in HG00353_S1_L001_R1_001.fastq file = 1501299476
arr_head = []
arr_seq = []
arr_qs = []
...
for i in range(0, line_count / 4):
    ...
    arr_qs.append(line4)
#print len(arr_head)
lc_align_sorted_count = sum(1 for line in open('output_line_number_L001_3_70.txt'))
